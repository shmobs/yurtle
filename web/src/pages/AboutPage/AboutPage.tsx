  ...
  return (
    <>
      ...
      <div className="relative isolate overflow-clip">
        ...
        >
          <div
            className="relative left-[calc(50%-12rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#8646E6] to-[#5046E6] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
        ...
        <div className="mx-5 pb-32 pt-10 sm:pb-20 md:pt-20">
          <p className="prose mx-auto mb-32 sm:text-justify md:mb-20">
        ...
        <div
          className="absolute inset-x-0 top-[calc(100%-50rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-45rem)]"
          aria-hidden="true"
        >
          <div
